...
%                 regPara.step_size = 1/sqrt(iter+10);
                ...
                [Para, Ada] = Update_U(Para, Ada, regPara, Xtrain, Ytrain, view_index,train_index, loss_func);                   
...
function [ Para, Ada ] = Update_U( Para, Ada, regPara, X, Y, view_index, task_index, loss_func)
% U is a D * T matrix 
% f(x) = z^T*U + <W,Z>
